...
public class UserService implements IUserService {
    ...
    public List<User> getAllUserScoreOrderWise(ScoreOrder scoreOrder){
        ...
        //     {
        //         return compare(u1.getScore(),u2.getScore());
        ...
        Collections.sort(users,new Comparator<User>() {
         @Override
           public int compare(User u1, User u2) {
                 return  Long.compare(u1.getScore(),u2.getScore());        
       }
       });            
    
        if(scoreOrder.toString() == "DESC")
        {
    ...
    public UserRegistrationDto withdrawContest(String contestId, String userName) throws ContestNotFoundException, UserNotFoundException, InvalidOperationException {
        ...
        //     throw new InvalidOperationException("Cannot withdraw from Contest. Contest for given id:"+contestId+" not started!");
        // }
        // if(contest.getContestStatus().equals(ContestStatus.ENDED)){
        //     throw new InvalidOperationException("Cannot withdraw from Contest. Contest for given id:"+contestId+" has ended!");
        // }

        // if(!user.checkIfContestExists(contest)){
        //     throw new InvalidOperationException("Cannot withdraw from Contest. Contest for given id:"+contestId+" doesnt exist!");
        // }
